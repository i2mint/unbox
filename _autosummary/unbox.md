...
| [`base`](unbox.base.md#module-unbox.base)                                   | Base functionality of unbox          |
|-----------------------------------------------------------------------------------------------------------|--------------------------------------|
| [`dependencies`](unbox.dependencies.md#module-unbox.dependencies)                   | Functions to check for dependencies. |
| [`missing_install_names`](unbox.missing_install_names.md#module-unbox.missing_install_names) | Finding missing install names        |
| [`recipes`](unbox.recipes.md#module-unbox.recipes)                             | Recipes using unbox                  |
